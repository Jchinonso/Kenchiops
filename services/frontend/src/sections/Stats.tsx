...
const Stats = () => (
  <section id="stats" aria-label="Platform statistics" className="py-20 bg-white dark:bg-gray-950">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {stats.map((stat) => (
          <div key={stat.value} className="text-center">
            ...
            <div className="text-4xl sm:text-5xl font-bold text-indigo-500 mb-2">{stat.value}</div>
