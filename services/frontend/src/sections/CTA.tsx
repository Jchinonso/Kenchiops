...
const CTA = () => (
  <section id="cta" aria-label="Get started" className="py-24 bg-zinc-950">
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <motion.div
        className="relative rounded-3xl p-12 md:p-20 text-center overflow-hidden border border-zinc-800/40"
        initial="hidden"
        whileInView="visible"
      ...
      >
        {/* Gradient background */}
        <div className="absolute inset-0 bg-gradient-to-br from-amber-500/10 via-zinc-900 to-violet-500/10" />
        ...
        <motion.h2
          ...
          className="relative text-3xl sm:text-4xl md:text-5xl font-display font-extrabold text-zinc-100 mb-5 tracking-tight"
        >
          Stop debugging CI failures manually.
        </motion.h2>
        <motion.p
          variants={itemVariants}
          className="relative text-lg text-zinc-400 max-w-xl mx-auto mb-10"
        >
