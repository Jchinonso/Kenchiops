    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-24">
      <div className="text-center">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-2 bg-indigo-50 rounded-full mb-8">
          ...
          <span className="text-sm font-medium text-indigo-600">AI-Powered CI/CD Intelligence</span>
        </div>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
          ...
          <a
            href="/#cta"
            className="flex items-center gap-2 px-8 py-4 bg-white hover:bg-gray-50 text-gray-900 font-semibold rounded-lg border border-gray-200 transition-all duration-200"
          >
            BOOK A DEMO
        ...
        <div className="pt-8 border-t border-gray-200">
          <p className="text-sm text-gray-500 mb-6">Trusted by engineering teams everywhere</p>
          <div className="flex flex-wrap items-center justify-center gap-x-10 gap-y-4 opacity-60">
            {["Vercel", "LaunchDarkly", "CircleCI", "Buildkite", "Render", "Railway"].map(
              (name) => (
                <span key={name} className="text-gray-400 font-semibold text-lg tracking-tight">
                  {name}
                </span>
              )
            )}
