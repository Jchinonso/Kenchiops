    ...
    >
      <div className="flex-1 min-w-0">
        <p className="text-sm text-gray-700 dark:text-gray-300">
          <span className="font-semibold text-gray-900 dark:text-gray-100">{message.company}</span>{" "}
          {message.action}
          {message.time && (
            <>
              {" "}
              <span className="text-indigo-500 font-medium">{message.time}</span>
            </>
          )}
        </p>
      </div>
      <button
        ...
        className="flex-shrink-0 p-0.5 text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 transition-colors rounded"
      >
