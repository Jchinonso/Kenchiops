...
export default defineConfig({
  ...
  server: {
    proxy: {
      ...
      "/webhooks/pagerduty": "http://localhost:3004",
      "/webhooks/vercel": "http://localhost:3004",
      "/webhooks/netlify": "http://localhost:3004",
      "/webhooks/datadog": "http://localhost:3004",
      "/webhooks/grafana": "http://localhost:3004",
      "/webhooks/prometheus": "http://localhost:3004",
