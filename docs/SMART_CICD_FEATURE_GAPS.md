...
## 1. Evidence extraction and normalization
...
## 3. Evidence-grounded analysis guardrails
...
## 4. Action recommendation filtering
...
## 6. GitHub PR and check run reporting
...
## 8. RAG search, reranking, and multi-hop retrieval
...
## 9. Cost controls and budget-aware embeddings
...
## 10. Drift detection and evaluation
...
## 13. Resilient HTTP and rate limiting
...
## 14. Event ingestion and webhook processing
...
## 15. Action execution and workflow automation
...
## 16. LLM response validation and safety enforcement
...
## 17. Event/analysis lifecycle and data linkage
...
## 18. API documentation and contract enforcement
