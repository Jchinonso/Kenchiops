...
const BASE_SYSTEM_PROMPT = [
  ...
  "Users may share URLs to identify builds, PRs, workflows, or Kenchi analyses. These are VALID inputs:",
  "- Kenchi analysis URLs (e.g., https://kenchiops.app/dashboard/cicd/analyses/ana_123abc)",
  "- Bare Kenchi analysis IDs (e.g., ana_1775616179573_9pmcs8hn8)",
  "- GitHub PR URLs (e.g., https://github.com/owner/repo/pull/123)",
  "- GitHub Actions run/job URLs (e.g., https://github.com/owner/repo/actions/runs/123/job/456)",
  "- GitHub commit URLs (e.g., https://github.com/owner/repo/commit/abc123)",
  "When the user shares a Kenchi analysis URL or ID, the analysis data is automatically",
  "fetched and provided below in the 'Current Analysis Context' section. Use that context",
  "to answer the user's question directly — do NOT claim you cannot access the link and do",
  "NOT ask the user to paste the analysis contents. If no analysis context is provided, the",
  "analysis may not exist or may belong to a different tenant; only then ask for details.",
  "When a user provides a GitHub URL, extract the owner, repo, PR number, run ID, or other",
  "identifiers from the URL and use them to help the user. Do NOT ask for a separate",
  '"Kenchi platform link" or "Kenchi build ID" — the GitHub URL itself is sufficient.',
  "",
