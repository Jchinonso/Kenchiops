...
export const config: Config = {
  ...
  SERVICE_HMAC_SECRET_API: process.env.SERVICE_HMAC_SECRET_API,
  SERVICE_HMAC_SECRET_GITHUB_APP: process.env.SERVICE_HMAC_SECRET_GITHUB_APP,
  SERVICE_HMAC_SECRET_SLACK_BOT: process.env.SERVICE_HMAC_SECRET_SLACK_BOT,
  SERVICE_HMAC_SECRET_INCIDENT_TRIAGE: process.env.SERVICE_HMAC_SECRET_INCIDENT_TRIAGE,
